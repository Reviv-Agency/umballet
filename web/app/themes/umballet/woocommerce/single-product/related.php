...
<section class="aew-prsv2 aew-prsv2--related" data-aew-products-slider-v2>
	<div class="aew-prsv2__inner">
		...
		<div class="aew-prsv2__viewport">
			<button type="button" class="aew-prsv2__arrow aew-prsv2__arrow--prev" data-aew-prs-prev aria-label="<?php esc_attr_e( 'Previous products', 'umballet' ); ?>">
			...
			<button type="button" class="aew-prsv2__arrow aew-prsv2__arrow--next" data-aew-prs-next aria-label="<?php esc_attr_e( 'Next products', 'umballet' ); ?>">
